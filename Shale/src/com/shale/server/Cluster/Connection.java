...
if (fromConcept == true) {
	s = s + " from-id: [" + concept.id + "] ["+ concept.label + "] to-id --"+ linkingPhrase.id + " --" + linkingPhrase.label + "--";
	return s;
	}

else {
	s = s + " from-id: --" + linkingPhrase.id + "-- --" + linkingPhrase.label+ "-- to-id  ["+ concept.id + "] ["+ concept.label + "]";
	return s;
